...
if missing:
    print("Admin_/official R32 editor verification superseded by editable site official truth JSON workflow:")
    for rel in missing:
        print(f"- missing {rel}")
    raise SystemExit(1)
...
if "data/current/official_truth.json" not in runtime or "player picks remain Supabase-backed" not in runtime:
    print("Admin_/official R32 editor verification superseded by editable site official truth JSON workflow: replacement runtime verifier is not protecting site-owned official truth source")
    raise SystemExit(1)

print("OK: Admin_/official R32 editor verifier superseded by editable site official truth JSON workflow.")
