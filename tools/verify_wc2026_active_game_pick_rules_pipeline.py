...
# Legacy check: active game pick rules pipeline.
import subprocess
import sys
...
print("OK: legacy active game pick rules pipeline verifier superseded by one-game Admin_/official runtime rule.")
