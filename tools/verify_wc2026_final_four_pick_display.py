...
require("site/css/board.css", 'grid-template-areas: "missed-pick-stack"', "missed flag and code paint in one stack")
require("site/css/board.css", ".picked-cell-result-comparison .picked-cell-identity .picked-cell-flag", "missed flag background layer")
require("site/css/board.css", ".picked-cell-result-comparison .picked-cell-identity .picked-cell-code", "struck code foreground layer")
