...
# Legacy check: group stage hides later round pick fills.
import subprocess
import sys
...
print("OK: legacy group stage hides later round pick fills verifier superseded by one-game Admin_/official runtime rule.")
