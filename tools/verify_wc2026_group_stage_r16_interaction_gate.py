...
# Legacy check: group stage R16 interaction gate.
import subprocess
import sys
...
print("OK: legacy group stage R16 interaction gate verifier superseded by one-game Admin_/official runtime rule.")
