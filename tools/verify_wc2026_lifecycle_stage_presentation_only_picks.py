...
# Legacy check: lifecycle stage presentation only picks.
import subprocess
import sys
...
print("OK: legacy lifecycle stage presentation only picks verifier superseded by one-game Admin_/official runtime rule.")
